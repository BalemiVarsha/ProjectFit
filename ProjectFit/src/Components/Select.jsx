...
const Select = () => {
  return (
   <React.Fragment>
     {/* <img  src="/src/img/pf1.png" alt="Project Fit" /> */}
    <div className='d-flex justify-content-center align-items-center vh-100 selectt'>
    <img className='rmimgg' src="/src/img/select.png"></img>
    
     <div className='p-5  w-15  loginFormm'>
         {/* <img className='imglogo' src="/src/img/pf1.png"></img> */}
         {/* <h2>Login Page</h2> */}
         <br></br>
         <form >
             <div className='formm'>
    ...
    //     <div>
    //       <NavLink to='/adminlogin'> <img src='/src/img/3.png'></img></NavLink> 
        
    //     </div>
    //     <div>
    //       <NavLink to='/projectmanagerlogin'> <img src='/src/img/4.png'></img></NavLink> 
    //     </div>
    // </div>
  )
}
